/**
 * @deprecated M11-R0 — P6 XER schedule import has been permanently retired.
 *
 ...
 * P6/MPP files cannot create or modify the native STO schedule.
 *
 * Historical data created by previous imports is preserved but no new imports are accepted.
 * If P6 integration is required in the future, it will be as an EXPORT-only boundary.
 */
import { NextRequest, NextResponse } from 'next/server';

const DEPRECATION_RESPONSE = {
  error: 'P6/XER schedule import has been permanently retired (M11-R0).',
